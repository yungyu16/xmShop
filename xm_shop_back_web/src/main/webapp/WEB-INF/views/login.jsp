...
<div class="container div-signin" style="margin-top: 99px">
    <div class="panel panel-primary div-shadow">
        ...
        <div class="panel-body">
            <!-- login form start -->
            <form action="${pageContext.request.contextPath}/admin/system_user/manager/login" class="form-horizontal"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <!-- 验证码 -->
                        <img class="img-rounded" id="randCode"
                             src="${pageContext.request.contextPath}/admin/code/getCodeImage"
