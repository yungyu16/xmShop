                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <c:if test="${customer.isValid == 0}">
                                <input type="button" class="btn btn-success btn-sm doDisable"
                                       onclick="modifyCustomerStatus(${customer.id},this)" value="启用">
                            </c:if>
                            <c:if test="${customer.isValid == 1}">
                                <input type="button" class="btn btn-danger btn-sm doDisable"
                                       onclick="modifyCustomerStatus(${customer.id},this)" value="禁用">
                            </c:if>
                        </td>
                    </tr>
                </c:forEach>
...
<div class="modal fade" tabindex="-1" id="myModal">
    ...
    <div class="modal-dialog">
        <!-- 内容声明 -->
        <form action="${pageContext.request.contextPath}/admin/customer/modifyCustomer" method="post"
